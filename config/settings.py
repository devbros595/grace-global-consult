...
# 2. Check if we are on Render. If DATABASE_URL exists, overwrite SQLite with PostgreSQL.
...
CLOUDINARY_STORAGE = {
    "CLOUD_NAME": "dkean9geh",
    "API_KEY": "333477243859878",
    "API_SECRET": "u2418_wNRV3E3kg7Zpk_P9yCkWY",
}
